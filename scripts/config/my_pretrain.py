    ...
    if cfg.do_training:
        ...
        if cfg.restore_from_path:
            ...
            model = MegaMolBARTModel.restore_from(
                cfg.restore_from_path, cfg.model, trainer=trainer, save_restore_connector=BioNeMoSaveRestoreConnector(), strict=False
            )
        else:
        ...
        for name, param in model.named_parameters():
            ...
            logging.info("***********************************************************")
#data preprocessing: else -> elif as below:
    elif cfg.get('do_preprocessing', False):
